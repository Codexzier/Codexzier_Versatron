...
#ifndef CODEXZIER_VERSATRON_APPRADIORADAR_H
#define CODEXZIER_VERSATRON_APPRADIORADAR_H
#include "BaseDrawable.h"


class AppRadioRadar : public BaseDrawable {
...
#endif //CODEXZIER_VERSATRON_APPRADIORADAR_H
